...
if [[ -n "${C_VERSION}" ]]; then
    LDFLAGS="${LDFLAGS} -X github.com/jvzantvoort/tmux-project/version.Version=${C_VERSION}"
fi

if [[ -n "${C_REVISION}" ]]; then
    LDFLAGS="${LDFLAGS} -X github.com/jvzantvoort/tmux-project/version.Commit=${C_REVISION}"
fi

if [[ -n "${C_BUILDTIME}" ]]; then
    LDFLAGS="${LDFLAGS} -X github.com/jvzantvoort/tmux-project/version.BuildTime=${C_BUILDTIME}"
fi
