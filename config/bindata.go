...
func templatesConfigYml() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/config.yml", size: 261, mode: os.FileMode(0664), modTime: time.Unix(1609525037, 0)}
...
func templatesDefaultEnv() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/default.env", size: 321, mode: os.FileMode(0664), modTime: time.Unix(1609379041, 0)}
...
func templatesDefaultRc() (*asset, error) {
	...
	info := bindataFileInfo{name: "templates/default.rc", size: 230, mode: os.FileMode(0664), modTime: time.Unix(1609442668, 0)}
