...
func messagesUsage_archive() (*asset, error) {
	...
	info := bindataFileInfo{name: "messages/usage_archive", size: 96, mode: os.FileMode(0664), modTime: time.Unix(1609532113, 0)}
...
func messagesUsage_create() (*asset, error) {
	...
	info := bindataFileInfo{name: "messages/usage_create", size: 92, mode: os.FileMode(0664), modTime: time.Unix(1609530425, 0)}
...
func messagesUsage_edit() (*asset, error) {
	...
	info := bindataFileInfo{name: "messages/usage_edit", size: 76, mode: os.FileMode(0664), modTime: time.Unix(1609532154, 0)}
...
func messagesUsage_list() (*asset, error) {
	...
	info := bindataFileInfo{name: "messages/usage_list", size: 96, mode: os.FileMode(0664), modTime: time.Unix(1609530218, 0)}
...
func messagesUsage_projectinit() (*asset, error) {
	...
	info := bindataFileInfo{name: "messages/usage_projectinit", size: 73, mode: os.FileMode(0664), modTime: time.Unix(1609532235, 0)}
