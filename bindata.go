...
func messagesBash() (*asset, error) {
	...
	info := bindataFileInfo{name: "messages/bash", size: 1386, mode: os.FileMode(0664), modTime: time.Unix(1609538455, 0)}
...
func messagesUsage_shell() (*asset, error) {
	...
	info := bindataFileInfo{name: "messages/usage_shell", size: 192, mode: os.FileMode(0664), modTime: time.Unix(1609538455, 0)}
